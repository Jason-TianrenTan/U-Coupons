...
import com.example.administrator.ccoupons.User.UserCoupons.Seller.SellerOnsaleAdapter;
...
public class SellerOnsaleFragment extends CouponCommonFragment {
    ...
    public void onEventCall(CouponListEvent clistEvent) {
        if (clistEvent.getListname().equals("SellerOnsale")) {
            System.out.println("on setData at seller fragment");
    ...
    public void initData() {
        adapter = new SellerOnsaleAdapter(adapterList);
